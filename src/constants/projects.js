export const PROJECTS = [
    ...
    },
    {
        ...
        description: "This was my capstone project for my undergraduate degree. " +
            "It is a full stack web application that uses React for the frontend and django for the backend." +
            "It scrape data from a websites for used automotive parts and allows users to search for parts and add them to their cart." +
    ...
    },
    {
        ...
        description: "This is an analytical chemistry software that I worked on while employed at Elemental Scientific." +
            "It uses SQLServer for the backend and WPF for the frontend. It is a fully featured software that aims to have an industry leading feature set",
